...
const Assignments = () => {
  ...
  const [activeIcon, setActiveIcon] = useState('assignments'); // Set 'assignments' as active icon initially
  ...
  return (
    <View style={[styles.container, { backgroundColor: currentBackgroundColor }]}>
      ...
      <View style={styles.mainContent}>
        <Text style={{ color: currentTextColor }}>Assignments Content Goes Here</Text>
      </View>
