...
const Performance = () => {
  ...
  const [activeIcon, setActiveIcon] = useState('performance'); // Set 'performance' as active icon initially
  ...
  return (
    <View style={[styles.container, { backgroundColor: currentBackgroundColor }]}>
      ...
      <View style={styles.mainContent}>
        <Text style={{ color: currentTextColor }}>Performance Content Goes Here</Text>
      </View>
